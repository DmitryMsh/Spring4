...
public class UserController {
    ...
    private final com.example.springsecurityapplication.repositories.ProductRepository productRepository;
    ...
    public UserController(OrderRepository orderRepository, CartRepository cartRepository, ProductService productService, ProductRepository ProductRepository,
                          com.example.springsecurityapplication.repositories.ProductRepository productRepository) {
